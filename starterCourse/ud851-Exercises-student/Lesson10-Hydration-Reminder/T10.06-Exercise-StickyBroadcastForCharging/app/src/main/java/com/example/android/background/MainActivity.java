...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            int batteryStatusValue = Integer.parseInt(batteryStatus.getStringExtra(BatteryManager.EXTRA_STATUS));

            if (BatteryManager.BATTERY_STATUS_CHARGING == batteryStatusValue ||
                    BatteryManager.BATTERY_STATUS_FULL == batteryStatusValue) {
                showCharging(true);
            }
        }
