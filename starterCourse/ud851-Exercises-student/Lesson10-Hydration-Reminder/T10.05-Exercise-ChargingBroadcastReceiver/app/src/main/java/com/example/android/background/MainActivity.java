...
public class MainActivity extends AppCompatActivity implements
    ...
    private void showCharging(boolean isCharging) {
        if (isCharging) {
            mChargingImageView.setImageResource(Integer.valueOf(R.drawable.ic_power_pink_80px));
        } else {
            mChargingImageView.setImageResource(Integer.valueOf(R.drawable.ic_power_grey_80px));
        }
    }
    ...
    private class ChargingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_POWER_CONNECTED.matches(action)) {
                showCharging(true);
            } else {
                showCharging(false);
            }
